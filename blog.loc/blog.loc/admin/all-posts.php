...
<main id="main-container">
    ...
    <div class="bg-body-light">
        <div class="content content-full">
            <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center">
                <h1 class="flex-grow-1 fs-3 fw-semibold my-2 my-sm-3">Barcha maqolalar</h1>
    ...
    <div class="content content-full">
        ...
        <div class="row text-center">
            ...
            <div class="col-6 col-xl-3">
                <!-- New Post -->
                <a class="block block-rounded" href="add-post.php">
                    <div class="block-content block-content-full">
                        <div class="py-md-3">
                            <div class="py-3 d-none d-md-block">
                            ...
                            <p class="fs-4 fw-bold mb-0">
                                <i class="fa fa-plus text-primary me-1 d-md-none"></i> Yangi maqola
                            </p>
                            <p class="text-muted mb-0">
                                John Doe dan
                            </p>
        ...
        <div class="block">
            ...
            <div class="block-content">
                <!-- Search Posts -->
                <form class="push" action="all-posts.php" method="POST">
