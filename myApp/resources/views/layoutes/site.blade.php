...
<body>
  ...
  <header id="header" class="fixed-top d-flex align-items-center">
    <div class="container d-flex align-items-center">
      ...
      <h1 class="logo me-auto"><a href="index.html">Norbek</a></h1>
        ...
        <ul>
          ...
          <li class="dropdown"><a href="#"><span>About</span> <i class="bi bi-chevron-down"></i></a>
            <ul>
              ...
              <li><a href="<?php echo route('team'); ?>">Team</a></li>
              <li><a href="<?php echo route('testimonial'); ?>">Testimonials</a></li>
            </ul>
          </li>
          <li><a href="<?php echo route('services'); ?>">Services</a></li>
          <li><a href="<?php echo route('portfolio'); ?>">Portfolio</a></li>
          <li><a href="<?php echo route('pricing'); ?>">Pricing</a></li>
